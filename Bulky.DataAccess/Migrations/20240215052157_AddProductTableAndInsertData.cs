...
{
    /// <inheritdoc />
    public partial class AddProductTableAndInsertData : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductPrice50 = table.Column<double>(type: "float", nullable: false),
                    ProductPrice100 = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductID", "ProductAuthor", "ProductDescription", "ProductISBN", "ProductListPrice", "ProductPrice", "ProductPrice100", "ProductPrice50", "ProductTitle" },
                values: new object[,]
                {
